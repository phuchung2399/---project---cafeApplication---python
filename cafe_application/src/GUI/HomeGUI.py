...
class HomeGUI(Frame):
    ...
    def init_components(self):
        ...
        x_cordinate = int((self.__master.winfo_screenwidth()/2) - (1500/2))
        y_cordinate = int((self.__master.winfo_screenheight()/2) - (1000/2))
        self.__master.geometry("{}x{}+{}+{}".format(1500, 760, x_cordinate, y_cordinate))

        self.contentPane = Frame( bg="#ffffff", width=1500, height=1000)
        self.contentPane.master = self.__master
        self.contentPane.pack(fill="both", expand=True)

        self.west = Frame(self.contentPane, bg="#23a661", width=300, height=1000)
